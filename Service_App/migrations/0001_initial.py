# Generated by Django 5.1.1 on 2025-09-07 14:26
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('requirements', models.TextField(help_text='Describe your requirements in detail', max_length=1000)),
                ('contact_info', models.CharField(blank=True, max_length=200)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('admin_response', models.TextField(blank=True, max_length=1000)),
